...
start :-sleep(0.4),	
    ...
    hypothesis(Patient,measles) :-
		...
		nl,
		write('There is no treatment to get rid of an established measles infection, but over the counter fever reducers or vitamin A may help with symptoms.'),
		nl,!.
    ...
    hypothesis(Patient,german_measles) :-
        ...
        symptom(Patient,rash),
		nl,
		write('There is no  treatment to get rid of an established infection,but medications may help with symptoms. Take analgesic to relieve pain.'),
		nl,!.
    ...
    hypothesis(Patient,flu) :-
        ...
        symptom(Patient,cough),
		nl,
		write('Take antiviral drug to reduce viruses ability to replicate and analgesic to relieve pain,cough medicine,decongestant to relieve nasal congestion,swelling and runny nose'),
		nl,!.    
    ...
    hypothesis(Patient,common_cold) :-
        ...
        symptom(Patient,chills),
		nl,
		write('Take analgesic to relive pain, Antihitamine to reduce or stop an allergic reaction , Cough medicine and decongestant to relieve nasal congestion , swelliing and runny nose'),
		nl,!.
    ...
    hypothesis(Patient,mumps) :-
		...
		nl,
		write('Take over the counter pain relievers, such as acetaminophen and ibuprofen,to bring down your fever. Soothe swollen glands by applying ice packs.Eat a soft diet and avoid acidic foods and beverages.'),
		nl,!.
    ...
    hypothesis(Patient,chicken_pox) :-
        ...
        symptom(Patient,rash),
		nl,
		write('Chicken pox can be prevented by a vaccine.Take Analgesic to relieve pain and antihistamine to reduce or stop an allergic reaction.'),
		nl,!.
    ...
    hypothesis(Patient,measles) :-
        ...
        symptom(Patient,runny_nose),
		nl,
		write('There is no specific treatment. Take Rest and plenty of fluids to prevent dehydration'),
		nl,!.
